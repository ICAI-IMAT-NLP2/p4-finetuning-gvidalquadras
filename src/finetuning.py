...
class LoRA(nn.Module):
    def __init__(self, original_layer, r=4, alpha=32):
        ...
        self.A = nn.Parameter(torch.empty((in_features, r))) # in_dim x r
        self.B = nn.Parameter(torch.empty((r, out_features))) # r x out_dim 
...
class SoftPromptEmbedding(nn.Module):
    def __init__(self, prompt_length, model_hidden_size):
        ...
        nn.init.uniform_(self.soft_prompt, -0.1, 0.1)
